...
export default function Main() {
  return (
    <div className='justify-center'>
      <p className='ml-5 flex md:justify-center  mb-4 text-orange-700'>Serviços</p>
      ...
      <div className='flex flex-col mt-4 ml-5 md:flex-row leading-loose justify-between gap-20 md:m-24'>
