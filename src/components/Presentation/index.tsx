...
export default function Presentation () {
  ...
  // sm -> 640 px md-> 768 lg -> 1024
    return (
      <div className='flex  flex-row mt-5 ml-5 md:justify-around gap-36'>
        <div className=' flex flex-col  md:mt-15'>
          <p className='text-xs mb-3 sm:text-sm md:text-base font-normal  lg:text-base'>
